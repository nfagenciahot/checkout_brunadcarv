...
export default function HomePage(){
  ...
  return <main className="page">
    <div className="container profileShell">
      ...
      <div className="postsList" style={{display:activeMainTab==='posts'?'':'none'}}>
